...
public class StudentController {
	...
	/*
	 * public String loadStudent(int studentId) { logger.info("loading student: " +
	 * studentId); try { Student theStudent = studentDbUtil.getStudent(studentId);
	 ...
	 * 
	 * } catch (Exception exc) { logger.log(Level.SEVERE,
	 * "Error loading student id:" + studentId, exc); addErrorMessage(exc);
	 * 
	 * return null; }
	 * 
	...
	/*
	 * private void addErrorMessage(Exception exc) { FacesMessage message = new
	 * FacesMessage("Error: " + exc.getMessage());
